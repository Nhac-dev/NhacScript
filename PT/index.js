    ...
    const obj = task(
        (object)=>
        {
            if(typeof(object) == 'object')
            {
                ...
                {
                    log(`O elemento solicitado é um Array/lista, use o método "list()".`, 2)
                    return object
                }
                else
                {
            ...
            {
                log(`O elemento solicitado é ${typeof(object)}, use "list()" para array/lista, e "task()" para tarefas.`, 1)
                return undefined
            }
        }
    )
    const list = task(
        (arrayValue)=>
        {
            if(typeof(arrayValue)=='object')
            {
                ...
                {
                    log(`O element na verdade é um objeto, melhor usar o método "obj()".`, 2)
                    return arrayValue
                }
            }
            else
            {
                log(`O elemento na verdade é um/uma ${typeof(object)}, use "obj()" para objetos, e "task()" para tarefas. `, 1)
                return undefined
            }
        }
    )
...
// Conversor
    ...
    const toNum = task(
        (numTarget)=>
        {
            if(typeof(numTarget) != 'number')
            {
                ...
                {
                    log('O Elemento não é um número', 1)
                    return undefined
                }
            }
            else
    ...
    const toFlt = task(
        (numTarget)=>
        {
            ...
            {
                log('O argumento solicitado não é um número nem uma string!', 1)
            }
            else
            {
                if(numTarget <= 0 
                ...
                {
                    log('Este elemento não é um numero válido.', 1)
                    return undefined
                }
            }
        }
            ...
            this.click = (event)=>
            {
                if(event && typeof(event) == 'function'){
                    ...
                    if(!event){
                        ...
                        log(`O argumento solicitado não é uma tarefa/função.`, 1)
                    }
                }
            }
            this.dbClick = (event)=>
                    ...
                    value)=>
                {
                    ...
                    // Verification array, the array KEY is the css key, and the array VALUE is the css proprieties
                            ...
                            typeof(key) == 'object')
                        {
                            if(value)
                            {
                                log('Como o parâmetro chave é um objeto, o valor é desnecessário', 2)
                            }
...
// On get
    class NewGet{
        constructor(syntax)
        {
            ...
            {
                log(`O objeto solicitado não existe ou a sintaxe está incorreta, verifique: >"${sintaxe}"<`, 1)
            }
    ...
    class personEvent {
        constructor(event){
            if(typeof(event) === 'function'){
                ...
                log(`O evento chamado não é uma tarefa/função.`,1)
                return undefined
            }
        }
    }
