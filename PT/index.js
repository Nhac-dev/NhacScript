/*
    ...
    Repository link: https://github.com/Nhac-dev/NhacScriptt
        ...
        constructor(){
            this.CreateElement = (tag, set)=>{
                ...
                if(isTag){
                    ...
                    elm["createNS"] = true
                    elm.setId = (id)=>{
                        if(typeof value != "string") return new Error("Por favor adicione uma string")
                        elm.elm.id = id
                    }
                    elm.setText = (text)=>{
                        if(typeof value != "string") return new Error("Por favor adicione uma string")
                    ...
                    elm.append = (element)=>{
                        if(element == void 0) {
                            ...
                            log("Desculpe, como o argumento element não foi preenchido, botamos ele diretamente no body.", 2)
                        }
                    ...
                    if(set && typeof set == "object"){
                        ...
                        if(typeof set != "object" && typeof set != "undefined"){
                            elm.Error = "O argumento Set não é um objeto."
                            log(elm.Error, 1)
                        }
                    }
                    return elm
        ...
        constructor(syntax){
            ...
            if(this.element){
                // Minimal settings
                    ...
                    this.objectName = `<${objectName}> - get By NhacScriptt`
                    ...
                    this.element.getByNhacScriptt = true
        ...
        constructor(syntax){
            ...
            if(elm){
                ...
                for(let i=0;i<this.listElement.length;i++){
                    ...
                    this.listElement[i].objectName = `<${objectName}> - get By NhacScriptt`
...
window.NS_DOM = new NS_DOM(window)
